...
const scrollEntry1Html = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
export const scrollEntry1 = {
  "/index.html": scrollEntry1Html,
  "/style.css": scrollEntry1Style,
};

const scrollEntryCorssing1Html = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
const scrollEntryCorssing1Style = `body {
  font-family: "Microsoft YaHei", Arial, sans-serif;
  line-height: 1.6;
  max-width: 800px;
  margin: 40px auto;
...
export const scrollEntryCorssing1 = {
  "/index.html": scrollEntryCorssing1Html,
  "/style.css": scrollEntryCorssing1Style,
};

const scrollEntryCorssing2Html = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
const scrollEntryCorssing2Style = `body {
  font-family: "Microsoft YaHei", Arial, sans-serif;
  line-height: 1.6;
  max-width: 800px;
  margin: 40px auto;
...
export const scrollEntryCorssing2 = {
  "/index.html": scrollEntryCorssing2Html,
  "/style.css": scrollEntryCorssing2Style,
};

const scrollExit1Html = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
export const scrollExit1 = {
  "/index.html": scrollExit1Html,
  "/style.css": scrollExit1Style,
};

const scrollExitCorssing1Html = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
const scrollExitCorssing1Style = `body {
  font-family: "Microsoft YaHei", Arial, sans-serif;
  line-height: 1.6;
  max-width: 800px;
  margin: 40px auto;
...
export const scrollExitCorssing1 = {
